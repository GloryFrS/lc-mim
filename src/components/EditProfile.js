  ...
  async componentDidMount() {
    ...
    try {
      ...
      this.setState({
        ...
        country: res.data[0].address ? JSON.parse(res.data[0].address).country : '',
        city: res.data[0].address ? JSON.parse(res.data[0].address).city : '',
        street: res.data[0].address ? JSON.parse(res.data[0].address).street : '',
        house: res.data[0].address ? JSON.parse(res.data[0].address).house : '',
        vk: res.data[0].vk_id,
