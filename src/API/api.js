...
export default {
  ...
  mastersGet: params => axios.post('https://vk.masterimodel.com/node/masters.get', params),
  ...
  masterServices: params => axios.post('https://vk.masterimodel.com/node/masterServices.get', params),
