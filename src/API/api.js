...
export default {
  // master backend 
  allMastersGet: params => axios.get('http://vk.masterimodel.com/php/select.php', params),
  ...
  linkGet: params => axios.post('http://vk.masterimodel.com/node/banner.get', params),
